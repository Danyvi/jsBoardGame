class Game {
   ...
   * @param {Object}  e-Keydown event object that is passed to the event listener
   *                    callback method in app.js
   */
  /**
   * if the key pressed was the left arrow we'd like to call
   * the moveLeft method on the activeToken
   * The activeToken is accessed as a property on the activePlayer object
   * which thanks to our getter method is accessed as a property of the game object
   */
  handleKeydown(e) {
    if (this.ready) {
      if (e.key === "ArrowLeft") {
